...
const ENDPOINTS: Record<number, string> = {
  1: 'https://api.0x.org/swap/v1/price',
  10: 'https://optimism.api.0x.org/swap/v1/price',
  56: 'https://bsc.api.0x.org/swap/v1/price',
  137: 'https://polygon.api.0x.org/swap/v1/price',
  42161: 'https://arbitrum.api.0x.org/swap/v1/price',
  43114: 'https://avalanche.api.0x.org/swap/v1/price',
  8453: 'https://base.api.0x.org/swap/v1/price',
}
