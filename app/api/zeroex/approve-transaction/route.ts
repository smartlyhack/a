...
const ENDPOINTS: Record<number, string> = {
  1: 'https://api.0x.org/swap/v1/approve/transaction',
  10: 'https://optimism.api.0x.org/swap/v1/approve/transaction',
  56: 'https://bsc.api.0x.org/swap/v1/approve/transaction',
  137: 'https://polygon.api.0x.org/swap/v1/approve/transaction',
  42161: 'https://arbitrum.api.0x.org/swap/v1/approve/transaction',
  43114: 'https://avalanche.api.0x.org/swap/v1/approve/transaction',
  8453: 'https://base.api.0x.org/swap/v1/approve/transaction',
}
